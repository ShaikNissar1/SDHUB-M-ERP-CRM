    ...
    <main className="flex flex-col gap-6">
      <header className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl md:text-2xl font-semibold text-pretty">Teacher Attendance</h1>
      ...
      <Card>
        ...
        <CardContent>
          <AttendanceCalendarView personId={params.id} personName={personName} type="teacher" />
        </CardContent>
      </Card>
    </main>
  )
