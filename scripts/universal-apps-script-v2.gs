// ============================================================================
// UNIVERSAL GOOGLE APPS SCRIPT FOR EXAM MASTER (UPDATED)
// ============================================================================
// This script works for ALL exam types (Entrance, Main, Internal)
// Simply set the exam_id in cell AA1 of your Google Sheet (NOT Z1)
// 
// Setup Instructions:
// 1. Open your Google Sheet (linked to Google Form)
// 2. Go to Extensions > Apps Script
// 3. Paste this entire code
// 4. In cell AA1, paste the exam_id from your ERP Exam Master
...
function debugFormStructure() {
  ...
  console.log("[v0] ")
  console.log(`[v0] Cell ${EXAM_ID_CELL} (exam_id):`, sheet.getRange(EXAM_ID_CELL).getValue())
...
function testIntegration() {
  ...
  const sheet = SpreadsheetApp.getActiveSheet()
  const examId = sheet.getRange(EXAM_ID_CELL).getValue()

  if (!examId) {
    console.error(`[v0] ERROR: exam_id not found in ${EXAM_ID_CELL}`)
    return
  }
