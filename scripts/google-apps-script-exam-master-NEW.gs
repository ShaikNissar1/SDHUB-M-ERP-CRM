...
function onFormSubmit(e) {
  try {
    ...
    console.log("[v0] Extracted data:", { name, email, phone, course, scoreRaw, score, examId })
...
function debugFormStructure() {
  ...
  console.log("[v0] ============================================")
  console.log("[v0] === MAIN EXAM FORM - COLUMN STRUCTURE ===")
  console.log("[v0] ============================================")
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    const cellValue = String(data[i] || "").trim().substring(0, 50)
    console.log(`[v0] Column ${i} (${columnLetter}) | Header: "${headerText}" | Sample Value: "${cellValue}"`)
  }

  console.log("[v0] ")
  console.log("[v0] ============================================")
  console.log("[v0] Current COLUMN_MAPPING:")
  console.log("[v0] TIMESTAMP: " + COLUMN_MAPPING.TIMESTAMP)
  console.log("[v0] EMAIL: " + COLUMN_MAPPING.EMAIL)
  console.log("[v0] SCORE: " + COLUMN_MAPPING.SCORE)
  console.log("[v0] NAME: " + COLUMN_MAPPING.NAME)
  console.log("[v0] PHONE: " + COLUMN_MAPPING.PHONE)
  console.log("[v0] COURSE: " + COLUMN_MAPPING.COURSE)
  console.log("[v0] ============================================")
}
...
function checkTrigger() {
  ...
  if (formSubmitTriggers.length > 0) {
    SpreadsheetApp.getUi().alert("Trigger is set up correctly.");
  } else {
    SpreadsheetApp.getUi().alert("Trigger is not set up. Please create a trigger: onFormSubmit → On form submit.");
  }
}
...
function testFormSubmission() {
  console.log("[v0] Starting test form submission...");
  ...
  console.log("[v0] Test form submission completed.");
}
